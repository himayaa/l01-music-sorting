...
//Not sure how to debug. Not sure if program runs. Not sure how to set up debugger.
//Make sure .cpp runs after getting the fucking thing to work first
...
void MusicLibrary::get_options(int argc, char** argv) {
    ...
    */
    ...
    /*
        ...
        Add the remaining chars to the option string in
    ...
    while ((option = getopt_long(argc, argv, "p:nalh", longOpts, &option_index)) != -1) {
        switch (option) {
            ...
            /*
                ...
                Add the remaining cases and decide what to do when they occur.
